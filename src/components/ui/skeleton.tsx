...
function PlansSkeleton() {
  return (
    <div className="space-y-3">
      {Array.from({ length: 4 }).map((_, i) => (
        <div key={i} className="rounded-xl border border-border bg-surface-0 p-4">
          <div className="flex items-start gap-3">
...
export { Skeleton, IdeaCardSkeleton, FeedSkeleton, IdeaDetailSkeleton, ProfileSkeleton, DashboardSkeleton, TeamSkeleton, StatsSkeleton, PlansSkeleton, SharedPlanSkeleton }
