...
export function PrivacyPage() {
  return (
    <LegalLayout title="Privacy Policy">
      ...
      <h2>6. Contact</h2>
      <p>For privacy-related questions, contact us at privacy@{siteConfig.domain}.</p>
    </LegalLayout>
  )
}
...
export function TermsPage() {
  return (
    <LegalLayout title="User Agreement">
      ...
      <p>By using {siteConfig.name}, you agree to these terms. If you do not agree, please do not use our service.</p>

      <h2>2. Service Description</h2>
      <p>{siteConfig.name} is an AI-powered platform that generates business ideas. Ideas are generated by artificial intelligence and should be treated as starting points for further research and validation, not as guaranteed business plans.</p>
